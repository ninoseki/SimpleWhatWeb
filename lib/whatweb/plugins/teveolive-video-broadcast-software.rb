...
##
WhatWeb::Plugin.define "TeveoLive-Video-Broadcast-Software" do
  ...
  @matches = [
    ...
    # Tag Pattern
    # {:name=>'HTML Tag Pattern', :tag_pattern=>'html,head,title,/title,meta,/head,center,body,a,img,/a,table,tr,td,applet,param,param,param,param,/applet,/td,/tr,/table,font,a,/a,/font,/body,/center,/html'},

...
##
WhatWeb::Plugin.define "O2Micro-Firewall" do
  ...
  def passive(target)
    ...
    if target.headers["set-cookie"] =~ /^CGISESSID=01010011111100000000111110010011;/ && target.headers["server"] =~ /^(O2micro|Firewall)/

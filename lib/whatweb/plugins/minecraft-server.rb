...
##
WhatWeb::Plugin.define "Minecraft-Server" do
  ...
  def passive(target)
    ...
    m << { certainty: 75, name: "WWW-Authenticate Header" } if target.headers["www-authenticate"] =~ /Basic realm="Minecraft Admin Login" /

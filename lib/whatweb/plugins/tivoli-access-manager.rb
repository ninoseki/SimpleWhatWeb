...
##
WhatWeb::Plugin.define "Tivoli-Access-Manager" do
  ...
  def passive(target)
    ...
    m << { name: 'HTTP WWW Authenticate header' } if target.headers['www-authenticate'] =~ /realm="Access Manager for e-business"/

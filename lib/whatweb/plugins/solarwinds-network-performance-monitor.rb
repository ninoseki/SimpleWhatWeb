...
##
WhatWeb::Plugin.define "SolarWinds-Network-Performance-Monitor" do
  ...
  def passive(target)
    ...
    m << { string: "Broken" } if target.headers["location"] =~ /\/Admin\/CriticalError.asp\?ErrorMessage=<b>Cannot%20access%20main%20SQL%20Server%20database.<\/b>/

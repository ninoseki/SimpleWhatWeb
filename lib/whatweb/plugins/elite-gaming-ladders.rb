...
##
WhatWeb::Plugin.define "Elite-Gaming-Ladders" do
  ...
  @matches = [
    ...
    # target.body == Could not connet to database, check your config file. For assistance, contact us at www.eliteladders.com.
